...
(() => {
    ...
    window.addEventListener('load', () => {
        ...
        createTexture('./image/color.png', (texture0) => {
            createTexture('./image/height.png', (texture1) => {
    ...
    function init(texture){
        ...
        scenePrg.uniLocation[1] = gl.getUniformLocation(scenePrg.program, 'colorTexture');
        scenePrg.uniLocation[2] = gl.getUniformLocation(scenePrg.program, 'heightTexture');
        ...
        gl[scenePrg.uniType[2]](scenePrg.uniLocation[2], 1);
